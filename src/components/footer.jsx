  ...
  return (
    <footer className="relative grid grid-cols-12 gap-5 bg-black md:gap-2">
      ...
      <div className="col-span-12 flex flex-col items-start justify-between gap-10 p-10 md:col-span-2">
        ...
        />
        <div>
          <h3 className="text mb-1 text-xl font-semibold text-white">
            About NovelHire
          </h3>
          <p className="text-sm leading-5 text-muted-foreground">
            NovelHire is a premier AI-based Skill Assessment Platform focused on
            empowering organizations through targeted employee development.
          </p>
        </div>

        <Button
          variant="primary"
          className="rounded-none bg-theme-primary hover:bg-theme-secondary text-white"
        >
          Request Demo
          <ChevronRight />
        </Button>
      ...
      <div className="col-span-12 flex w-full flex-col items-center justify-between gap-4 p-10 md:col-span-10 md:p-10 md:pl-20">
        ...
        <div className="flex w-full flex-col items-center justify-between gap-5 md:flex-row">
          <span className="text-xs text-muted-foreground">{`Ⓒ ${year} NovelHire All Rights Reserved`}</span>
