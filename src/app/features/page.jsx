  ...
  return (
    <>
      <Assessment
        ...
        footer={["Test skills specific to each role.", "Save time with ready-made templates.", "Ensure objective evaluations."]}
      ...
      <Assessment
        ...
        buttonText="Learn more"
        footer={["Speed up time-to-hire.", "Reduce manual effort.", "Keep the hiring process on track."]}
        img="/features/profile.svg"
        reverse={true}
      />
      <Assessment
        ...
        buttonText="Learn more"
        footer={["Gain visibility into candidate performance.", "Reduce bias with objective metrics.", "Improve decision-making with data-backed insights"]}
        img="/features/profile.svg"
      />
    </>
  );
