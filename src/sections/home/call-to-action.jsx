...
const CallToAction = () => {
  return (
    ...
    >
      <p className="md:text-xs text-xs font-bold uppercase text-gray-400/60 text-center">Get started with novelhire!</p>
      <h1 className="md:text-5xl text-3xl font-bold text-theme-primary text-center">Start Hiring Smarter Today!</h1>
